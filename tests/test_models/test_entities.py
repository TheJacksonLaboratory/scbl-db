from scbl_db.models.entities import Institution, Person, Lab
from pytest import mark, raises
from pathlib import Path
from .fixtures import institution, person, delivery_parent_dir
class TestInstitution:
    ...
    def test_ror_id_with_info(self):
        ...
        name = 'Institution'
        short_name = 'INST'
        institution = Institution(ror_id=self.ror_id, email_format=self.email_format, name=name, short_name=short_name)
    ...
    def test_email_format_invalid_attribute(self):
        ...
        """
        with raises(ValueError):
            Institution(ror_id=self.ror_id, email_format=r'{non_existent_attribute}@jax.org')
...
class TestPerson:
    ...
    def test_orcid(self, institution: Institution, n_dashes_to_remove: int):
        ...
        person = Person(first_name='Ahmed', last_name='Said', orcid=orcid.replace('-', '', n_dashes_to_remove), institution=institution)
    ...
    def test_invalid_orcid(self, institution: Institution):
        ...
        """
        with raises(ValueError):
            Person(first_name='Ahmed', last_name='Said', orcid='invalid-orcid', institution=institution)
    ...
    def test_nonexistent_orcid(self, institution: Institution):
        ...
        """
        with raises(ValueError):
            Person(first_name='Ahmed', last_name='Said', orcid='9999-9999-9999-9999', institution=institution)
    ...
    def test_email_autogenerated(self, institution: Institution):
        ...
        """
        person = Person(first_name='Ahmed', last_name='Said', institution=institution, email='ahmed.said@jax.org')
...
class TestLab:
    ...
    """
    def test_auto_set_name(self, delivery_parent_dir: Path, institution: Institution, person: Person):
        """
    ...
    def test_auto_set_delivery_dir(self, delivery_parent_dir: Path, institution: Institution, person: Person):
        """
